PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.vendor.build.fingerprint=Redmi/lime_global/lime:10/QKQ1.200830.002/V12.0.4.0.QJQMIXM:user/release-keys \
    ro.vendor.build.fingerprint_real=Redmi/lime/lime:11/RKQ1.201004.002/21.3.10:user/release-keys/1615474356 \
    ro.vendor.cabc.enable=true \
    ro.vendor.colorpick_adjust=true \
    ro.vendor.display.sensortype=2 \
    ro.vendor.display.svi=1 \
    ro.vendor.extension_library=libqti-perfd-client.so \
    ro.vendor.miui.cust_variant=gb \
    ro.vendor.miui.region=GB \
