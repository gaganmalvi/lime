...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_cn.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_cn.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_global.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_global.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_cn.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_cn.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_global.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_global.xml \
...
# Inherit vendor
$(call inherit-product, vendor/qualcomm/pomelo/pomelo-vendor.mk)